...
An arcane scepter is a [spell](../spells/spells) magic tool that can store [experience](https://minecraft.wiki/w/Experience) 
...
The arcane scepter can be used to craft a [Bottle o' Enchanting](https://minecraft.wiki/w/Bottle_o%27_Enchanting) using 7 experience that is stored.
