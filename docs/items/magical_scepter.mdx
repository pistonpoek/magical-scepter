...
| ------- | ---------- | ------ | ------ |
| <Asset width={16} height={16} location="magicalscepter:scepter" title="Scepter" /> [Scepter](./scepter) | 1 | 5 / 7 | 71.4% |
| **<Asset width={16} height={16} location="magicalscepter:magical_scepter" title="Magical Scepter" /> Magical Scepter** | 1 | 2 / 7 | 28.6% |

### Mob Loot

When a [refractor](../entities/refractor) is killed there is a small chance (8.5%) of dropping a magical scepter; 
