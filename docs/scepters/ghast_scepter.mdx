...
## Infusion
The ghast scepter can be obtained by taking damage from a [ghast](https://minecraft.wiki/w/Ghast) to infuse a held [magical sceper](../items/magical_scepter).

### Attack - [Ghast Fireball](../spells/spells#ghast_fireball)
Shoot a [ghast fireball](https://minecraft.wiki/w/Fireball).
