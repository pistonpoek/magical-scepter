...
## Infusion
The shulker scepter can be obtained by taking damage from a [shulker](https://minecraft.wiki/w/Shulker) to infuse a held [magical sceper](../items/magical_scepter).
