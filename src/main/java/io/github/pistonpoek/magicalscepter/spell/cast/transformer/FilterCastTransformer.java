...
public record FilterCastTransformer(Holder<LootItemCondition> filters) implements CastTransformer {
    public static final MapCodec<FilterCastTransformer> MAP_CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    LootItemCondition.CODEC.fieldOf("filters").forGetter(FilterCastTransformer::filters)
